...
<fmt:timeZone value="Canada/Atlantic">
	<fmt:formatDate value="${today }" type="both" timeStyle="full"/> <span>(Canada/Atlantic)</span><br>
</fmt:timeZone>

<fmt:setTimeZone value="Europe/Athens" var="timeZone"/>
<fmt:formatDate value="${today }" timeZone="${timeZone }" type="both" timeStyle="full"/> <span>(Europe/Athens)</span><br>
